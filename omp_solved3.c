...
// Not all of the threads enter the print results function
// and becuase of this the code hangs at the barrier as it
// waits for the other threads which never enter. Hence
// removed the barrier in print_results
